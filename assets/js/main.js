...
/*     const $form = document.querySelector('#form');
    const $buttonMailto = document.querySelector('#emailContent');
    ...
    function handleSubmit(event){
      event.preventDefault();
      const form = new FormData(this);      
      $buttonMailto.setAttribute('href',`mailto:kodex90@hotmail.com?subject=${form.get('name')}--${form.get('email')}--${form.get('subject')}&body=${form.get('message')}` );
